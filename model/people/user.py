...
class User(UserMixin, db.Model):
    ...
    def save_user(name, cpf, gender, birth_date, phone, license, username, email,
        ...
        user = User(id=person.id, license=license, username=username, email=email, password=password)
    ...
    def update_user(data):
        ...
        User.query.filter_by(id=data['id'])\
                .update(dict(license=data['license'], username=data['username'], email=data['email'], password=data['password']))
